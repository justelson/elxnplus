      ...
      >
        <div className="p-6 flex flex-col h-full relative z-10">
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="p-3 rounded-none bg-white/5 border border-white/10 shadow-inner group-hover:bg-white/10 transition-colors">
              {theme.icon}
            </div>
            <div className="flex items-center gap-2">
               {item.file_url && (
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-9 w-9 rounded-none hover:bg-white/10 hover:text-primary transition-colors"
                  onClick={handleDownload}
                >
                  <Download className="h-4 w-4" />
                </Button>
              )}
              <div className="text-[10px] font-mono font-bold uppercase tracking-widest text-muted-foreground/60 bg-white/5 px-2 py-1 rounded-none border border-white/5">
                {item.type}
              </div>
            </div>
          </div>
