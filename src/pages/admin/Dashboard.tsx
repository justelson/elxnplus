      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {statCards.map((stat) => (
          <Button 
            ...
            variant="outline" 
            asChild
            className="h-auto py-4 flex flex-col gap-2 rounded-none border-white/5 bg-background/40 hover:bg-primary/5 hover:border-primary/30 transition-all group"
          >
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {statCards.map((stat, index) => (
              <motion.div
                ...
                className={`p-6 rounded-none border ${stat.border} ${stat.bg} backdrop-blur-sm relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300`}
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
             <div className="p-6 md:p-8 rounded-none border border-border bg-card/40 backdrop-blur-sm shadow-sm">
            ...
            {recentMedia.length === 0 ? (
              ...
              <div className="divide-y divide-border/40">
                {recentMedia.map((item) => (
                  ...
                  >
                    <div className="w-12 h-12 rounded-none bg-background/50 border border-border/50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
