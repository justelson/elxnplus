    ...
    <div className="min-h-screen overflow-x-hidden bg-background text-foreground selection:bg-primary/30 selection:text-primary-foreground font-sans flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 pt-32 pb-20 md:px-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <div className="relative w-full max-w-md group">
              ...
              <Input 
                ...
                className="pl-12 h-14 bg-secondary/30 border-border focus:border-primary/50 transition-all rounded-none text-base shadow-lg"
                value={searchQuery}
          ...
          >
            {filters.map((filter) => (
              <Button
                ...
                className={cn(
                  "rounded-none px-6 h-10 transition-all duration-300 font-medium",
        ...
        {loading ? (
          ...
          <div className="text-center text-muted-foreground py-20 border border-white/5 rounded-none bg-card/30">
          ...
          <div className="text-center text-muted-foreground py-32 border border-dashed border-white/5 rounded-none bg-card/20">
